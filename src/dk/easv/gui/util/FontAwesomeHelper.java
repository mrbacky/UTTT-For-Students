...
//        switch (playerId) {
//            case "0":
//                return WeatherIconFactory.get().createIcon(FontAwesomeIcon.DIAMOND);
//            case "1":
//                return WeatherIconFactory.get().createIcon(FontAwesomeIcon.TRASH);
//            case "TIE":
//                return WeatherIconFactory.get().createIcon(FontAwesomeIcon.BLACK_TIE);
//            default:
